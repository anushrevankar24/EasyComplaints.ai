"""
Django settings for EasyComplaints project.
...
SECRET_KEY = 'django-insecure-v9zgt)zico0gvyc=hi9^g-cw#jmbgk)aweqe45rndxnb&k@1$v'
...
ROOT_URLCONF = 'EasyComplaints.urls'
...
WSGI_APPLICATION = 'EasyComplaints.wsgi.application'
